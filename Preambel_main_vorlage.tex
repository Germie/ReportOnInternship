...
\lstset{	basicstyle 			= \tiny, 									% print whole listing small
...
\pagestyle{empty}															% keine Kopf/Fusszeile, keine Seitenzahlen
	%s\include{titlepage}			\cleardoublepage 					
%
...
\pagestyle{empty}															% keine Kopf/Fusszeile, keine Seitenzahlen
 	...
 	\include{Eigenstaendigkeit}	\cleardoublepage
 	\include{subject}			\cleardoublepage							% genstaendigkeitserklaerung
%
% 			PREFACE + ABSTRACT
%---------------------------------------------------------------------------------------
...
\renewcommand{\bibname}{Literaturverzeichnis}								% NUR ZU ANSCHAUUNGSZWECKEN IN DEM BEISPIEL
